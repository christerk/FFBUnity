namespace Fumbbl.Model.RollModifier
{
    public class PassModifier : AbstractModifier
    {
        ...
        public static PassModifier ShortPass = new PassModifier("Short Pass", 0) {DistanceModifier = true, Shortcut = "S", ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
        ...
        public static PassModifier NervesOfSteel = new PassModifier("Nerves of Steel", 0) {ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
        ...
        public static PassModifier Blizzard = new PassModifier("Blizzard", 0) {ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
