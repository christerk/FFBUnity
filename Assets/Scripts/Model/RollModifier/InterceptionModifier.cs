namespace Fumbbl.Model.RollModifier
{
    public class InterceptionModifier : AbstractModifier
    {
        ...
        public static InterceptionModifier NervesOfSteel = new InterceptionModifier("Nerves of Steel", 0) {ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
