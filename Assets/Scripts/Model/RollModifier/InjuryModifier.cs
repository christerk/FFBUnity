namespace Fumbbl.Model.RollModifier
{
    public class InjuryModifier : AbstractModifier
    {
        ...
        public override ShowModifierSignMode ShowModifierSign { get; set; } = ShowModifierSignMode.ShowReversed;
        ...
        public static InjuryModifier Stunty = new InjuryModifier("Stunty", 0) {ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
        public static InjuryModifier ThickSkull = new InjuryModifier("Thick Skull", 0) {ShowModifierSign = ShowModifierSignMode.Hidden, ShowModifier = false, ShowName = false};
